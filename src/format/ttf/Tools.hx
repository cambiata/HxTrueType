...
class Tools {
	...
	static function dumpTHmtx(metrics:Array<Metric>):String {
		...
		for (i in 0...metrics.length) {
			...
			buf.add(metrics[i].advanceWidth);
			buf.add(', leftSideBearing:');
			buf.add(metrics[i].leftSideBearing);
		}
		return buf.toString();
	}
	...
	static function dumpTPost(data:PostData):String {
		buf.add('\n================================= post table =================================\n');
		buf.add('version : ');
		buf.add(data.version);
		buf.add('\nitalicAngle : ');
		buf.add(data.italicAngle);
		buf.add('\nunderlinePosition : ');
		buf.add(data.underlinePosition);
		buf.add('\nunderlineThickness : ');
		buf.add(data.underlineThickness);
		buf.add('\nisFixedPitch : ');
		buf.add(data.isFixedPitch);
		buf.add('\nminMemType42 : ');
		buf.add(data.minMemType42);
		buf.add('\nmaxMemType42 : ');
		buf.add(data.maxMemType42);
		buf.add('\nminMemType1 : ');
		buf.add(data.minMemType1);
		buf.add('\nmaxMemType1 : ');
		buf.add(data.maxMemType1);
		buf.add('\nnumGlyphs : ');
		buf.add(data.numGlyphs);
		buf.add('\n');
	...
	static function dumpTHhea(data:HheaData):String {
		...
		buf.add(data.version);
		buf.add('\nascender: ');
		buf.add(data.ascender);
		buf.add('\ndescender: ');
		buf.add(data.descender);
		buf.add('\nlineGap: ');
		buf.add(data.lineGap);
		buf.add('\nadvanceWidthMax: ');
		buf.add(data.advanceWidthMax);
		buf.add('\nminLeftSideBearing: ');
		buf.add(data.minLeftSideBearing);
		buf.add('\nminRightSideBearing: ');
		buf.add(data.minRightSideBearing);
		buf.add('\nxMaxExtent: ');
		buf.add(data.xMaxExtent);
		buf.add('\ncaretSlopeRise: ');
		buf.add(data.caretSlopeRise);
		buf.add('\ncaretSlopeRun: ');
		buf.add(data.caretSlopeRun);
		buf.add('\ncaretOffset: ');
		buf.add(data.caretSlopeRun);
		buf.add('\nmetricDataFormat: ');
		buf.add(data.metricDataFormat);
		buf.add('\nnumberOfHMetrics: ');
		buf.add(data.numberOfHMetrics);
		return buf.toString();
	}
	...
	static function dumpTHead(data:HeadData):String {
		...
		buf.add(data.version);
		buf.add('\nfontRevision : ');
		buf.add(data.fontRevision);
		buf.add('\ncheckSumAdjustment :');
		buf.add(data.checkSumAdjustment);
		buf.add('\nmagicNumber:');
		buf.add(data.magicNumber);
		buf.add('\nflags:');
		buf.add(data.flags);
		buf.add('\nunitsPerEm: ');
		buf.add(data.unitsPerEm);
		buf.add('\ncreated:');
		buf.add(data.created);
		buf.add('\nmodified:');
		buf.add(data.modified);
		buf.add('\nxMin: ');
		buf.add(data.xMin);
		buf.add('\nyMin: ');
		buf.add(data.yMin);
		...
		buf.add(data.yMax);
		buf.add('\nmacStyle: ');
		buf.add(data.indexToLocFormat);
		buf.add('\nlowestRecPPEM:');
		buf.add(data.lowestRecPPEM);
		buf.add('\nfontDirectionHint: ');
		buf.add(data.fontDirectionHint);
		buf.add('\nindexToLocFormat: ');
		buf.add(data.indexToLocFormat);
		buf.add('\nglyphDataFormat: ');
		buf.add(data.glyphDataFormat);
		return buf.toString();
	}
	...
	static function dumpTMaxp(data:MaxpData):String {
		...
		buf.add(data.versionNumber);
		buf.add('\nnumGlyphs:');
		buf.add(data.numGlyphs);
		buf.add('\nmaxPoints:');
		buf.add(data.maxPoints);
		buf.add('\nmaxContours:');
		buf.add(data.maxContours);
		buf.add('\nmaxComponentPoints:');
		buf.add(data.maxComponentPoints);
		buf.add('\nmaxComponentContours:');
		buf.add(data.maxComponentContours);
		buf.add('\nmaxZones:');
		buf.add(data.maxZones);
		buf.add('\nmaxTwilightPoints:');
		buf.add(data.maxTwilightPoints);
		buf.add('\nmaxStorage:');
		buf.add(data.maxStorage);
		buf.add('\nmaxFunctionDefs:');
		buf.add(data.maxFunctionDefs);
		buf.add('\nmaxInstructionDefs:');
		buf.add(data.maxInstructionDefs);
		buf.add('\nmaxStackElements:');
		buf.add(data.maxStackElements);
		buf.add('\nmaxSizeOfInstructions:');
		buf.add(data.maxSizeOfInstructions);
		buf.add('\nmaxComponentElements:');
		buf.add(data.maxComponentElements);
		buf.add('\nmaxComponentDepth:');
		buf.add(data.maxComponentDepth);
		return buf.toString();
	}
	...
	static function dumpTOS2(data:OS2Data):String {
		...
		buf.add(data.version);
		buf.add('\nxAvgCharWidth : ');
		buf.add(data.xAvgCharWidth);
		buf.add('\nusWeightClass : ');
		buf.add(data.usWeightClass);
		buf.add('\nusWidthClass : ');
		buf.add(data.usWidthClass);
		buf.add('\nfsType : ');
		buf.add(data.fsType);
		buf.add('\nySubscriptXSize : ');
		buf.add(data.ySubscriptXSize);
		buf.add('\nySubscriptYSize : ');
		buf.add(data.ySubscriptYSize);
		buf.add('\nySubscriptXOffset : ');
		buf.add(data.ySubscriptXOffset);
		buf.add('\nySubscriptYOffset : ');
		buf.add(data.ySubscriptYOffset);
		buf.add('\nySuperscriptXSize : ');
		buf.add(data.ySuperscriptXSize);
		buf.add('\nySuperscriptYSize : ');
		buf.add(data.ySuperscriptYSize);
		buf.add('\nySuperscriptXOffset : ');
		buf.add(data.ySuperscriptXOffset);
		buf.add('\nySuperscriptYOffset : ');
		buf.add(data.ySuperscriptYOffset);
		buf.add('\nyStrikeoutSize : ');
		buf.add(data.yStrikeoutSize);
		buf.add('\nyStrikeoutPosition : ');
		buf.add(data.yStrikeoutPosition);
		buf.add('\nsFamilyClass : ');
		buf.add(data.sFamilyClass);

		buf.add('\nbFamilyType : ');
		buf.add(data.bFamilyType);
		buf.add('\nbSerifStyle : ');
		buf.add(data.bSerifStyle);
		buf.add('\nbWeight : ');
		buf.add(data.bWeight);
		buf.add('\nbProportion : ');
		buf.add(data.bProportion);
		buf.add('\nbContrast : ');
		buf.add(data.bContrast);
		buf.add('\nbStrokeVariation : ');
		buf.add(data.bStrokeVariation);
		buf.add('\nbArmStyle : ');
		buf.add(data.bArmStyle);
		buf.add('\nbLetterform : ');
		buf.add(data.bLetterform);
		buf.add('\nbMidline : ');
		buf.add(data.bMidline);
		buf.add('\nbXHeight : ');
		buf.add(data.bXHeight);

		buf.add('\nulUnicodeRange1 : ');
		buf.add(data.ulUnicodeRange1);
		buf.add('\nulUnicodeRange2 : ');
		buf.add(data.ulUnicodeRange2);
		buf.add('\nulUnicodeRange3 : ');
		buf.add(data.ulUnicodeRange3);
		buf.add('\nulUnicodeRange4 : ');
		buf.add(data.ulUnicodeRange4);
		buf.add('\nachVendorID : ');
		buf.add(data.achVendorID);
		buf.add('\nfsSelection : ');
		buf.add(data.fsSelection);
		buf.add('\nusFirstCharIndex : ');
		buf.add(data.usFirstCharIndex);
		buf.add('\nusLastCharIndex : ');
		buf.add(data.usLastCharIndex);
		buf.add('\nsTypoAscender : ');
		buf.add(data.sTypoAscender);
		buf.add('\nsTypoDescender : ');
		buf.add(data.sTypoDescender);
		buf.add('\nsTypoLineGap : ');
		buf.add(data.sTypoLineGap);
		buf.add('\nusWinAscent : ');
		buf.add(data.usWinAscent);
		buf.add('\nusWinDescent : ');
		buf.add(data.usWinDescent);
		/*
