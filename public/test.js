...
format_ttf_Reader.prototype = {
	read: function() {
		...
		var hheaData = this.readHheaTable(__map_reserved["hhea"] != null ? _this.getReserved("hhea") : _this.h["hhea"]);
		tables.push(format_ttf_Table.THhea(hheaData));
		var _this1 = this.tablesHash;
		var headData = this.readHeadTable(__map_reserved["head"] != null ? _this1.getReserved("head") : _this1.h["head"]);
		tables.push(format_ttf_Table.THead(headData));
		var _this2 = this.tablesHash;
		var maxpData = this.readMaxpTable(__map_reserved["maxp"] != null ? _this2.getReserved("maxp") : _this2.h["maxp"]);
		...
		var os2Data = this.readOS2Table(__map_reserved["OS_2"] != null ? _this8.getReserved("OS_2") : _this8.h["OS_2"]);
	...
	,readHeader: function() {
		return { majorVersion : this.input.readUInt16(), minorVersion : this.input.readUInt16(), numTables : this.input.readUInt16(), searchRange : this.input.readUInt16(), entrySelector : this.input.readUInt16(), rangeShift : this.input.readUInt16()};
	}
