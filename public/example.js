...
Example.main = function() {
	...
	console.log("src/Example.hx:15:","Font name: " + ttfGlyphs.fontName);
	console.log("src/Example.hx:16:","Nr of glyph descriptions: " + ttfGlyphs.length);
	var scale = 3;
	var translateY = -1000;
	var _g = 0;
	var _g1 = ttfGlyphs.length;
	while(_g < _g1) {
		var index = _g++;
...
truetype_Glyph2SVG.getGlyphSvg = function(ttfGlyphs,index,displayScale,translateY,fillColor) {
	...
	var MAGIC_SVG_SCALE = 0.064;
	var scale1 = MAGIC_SVG_SCALE * displayScale;
...
truetype_GlyphTools.createGlyphMap = function(indexes,ttfGlyphs) {
	...
	while(_g < indexes.length) {
		...
		++_g;
		if(!ttfGlyphs.isGlyphSimple(index)) {
			console.log("src/truetype/GlyphTools.hx:14:","TTF Problem here: This glyph index (" + index + ") does not seem to be of type GlyphSimple...");
			continue;
		}
		var outlines = ttfGlyphs.getGlyphOutlines(index);
